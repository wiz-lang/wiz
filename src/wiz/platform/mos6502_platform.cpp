...
namespace wiz {
    ...
    void Mos6502Platform::reserveDefinitions(Builtins& builtins) {
        ...
        const auto patternImmZPU8 = revision == Revision::Huc6280 ? builtins.emplaceInstructionOperandPattern(InstructionOperandPattern::IntegerRange(Int128(0x2000), Int128(0x20FF))) : patternImmU8;
        ...
        const auto encodingRepeatedU16Operand = builtins.emplaceInstructionEncoding(
            [](const InstructionOptions& options, const std::vector<std::vector<const InstructionOperand*>>& captureLists) {
                return static_cast<std::size_t>(captureLists[options.parameter[0]][0]->variant.get<InstructionOperand::Integer>().value) * (options.opcode.size() + 2);
            },
            [](Report* report, const Bank* bank, std::vector<std::uint8_t>& buffer, const InstructionOptions& options, const std::vector<std::vector<const InstructionOperand*>>& captureLists, SourceLocation location) {
                static_cast<void>(report);
                static_cast<void>(bank);
        ...
        for (const auto& op : arithmeticOperators) {
            for (const auto& sig : arithmeticOperandSignatures) {
                ...
                builtins.emplaceInstruction(InstructionSignature(op.first, 0, {patternA, std::get<0>(sig)}), std::get<1>(sig), InstructionOptions(std::move(opcode), {1}, {}));
            }
        }
        // sta
        for (const auto& sig : arithmeticOperandSignatures) {
            ...
            builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {std::get<0>(sig), patternA}), std::get<1>(sig), InstructionOptions(std::move(opcode), {0}, {}));
        }
        // bit - overflow = mem $ 6, negative = mem $ 7, zero = a & mem
        builtins.emplaceInstruction(InstructionSignature(InstructionType::VoidIntrinsic(bit), 0, {patternZeroPage}), encodingU8Operand, InstructionOptions({0x24}, {0}, {}));
        builtins.emplaceInstruction(InstructionSignature(InstructionType::VoidIntrinsic(bit), 0, {patternAbsolute}), encodingU16Operand, InstructionOptions({0x2C}, {0}, {}));
        // ldx
        builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternX, patternImmU8}), encodingU8Operand, InstructionOptions({0xA2}, {1}, {}));
        builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternX, patternZeroPage}), encodingU8Operand, InstructionOptions({0xA6}, {1}, {}));
        builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternX, patternZeroPageIndexedByY}), encodingU8Operand, InstructionOptions({0xB6}, {1}, {}));
        builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternX, patternAbsolute}), encodingU16Operand, InstructionOptions({0xAE}, {1}, {}));
        builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternX, patternAbsoluteIndexedByY}), encodingU16Operand, InstructionOptions({0xBE}, {1}, {}));
        // ldy
        builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternY, patternImmU8}), encodingU8Operand, InstructionOptions({0xA0}, {1}, {}));
        builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternY, patternZeroPage}), encodingU8Operand, InstructionOptions({0xA4}, {1}, {}));
        builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternY, patternZeroPageIndexedByX}), encodingU8Operand, InstructionOptions({0xB4}, {1}, {}));
        builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternY, patternAbsolute}), encodingU16Operand, InstructionOptions({0xAC}, {1}, {}));
        builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternY, patternAbsoluteIndexedByX}), encodingU16Operand, InstructionOptions({0xBC}, {1}, {}));
        // stx
        builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternZeroPage, patternX}), encodingU8Operand, InstructionOptions({0x86}, {0}, {}));
        builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternZeroPageIndexedByY, patternX}), encodingU8Operand, InstructionOptions({0x96}, {0}, {}));
        builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternAbsolute, patternX}), encodingU16Operand, InstructionOptions({0x8E}, {0}, {}));
        // sty
        builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternZeroPage, patternY}), encodingU8Operand, InstructionOptions({0x84}, {0}, {}));
        builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternZeroPageIndexedByX, patternY}), encodingU8Operand, InstructionOptions({0x94}, {0}, {}));
        builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternAbsolute, patternY}), encodingU16Operand, InstructionOptions({0x8C}, {0}, {}));
        // cpx
        builtins.emplaceInstruction(InstructionSignature(InstructionType::VoidIntrinsic(cmp), 0, {patternX, patternImmU8}), encodingU8Operand, InstructionOptions({0xE0}, {1}, {}));
        builtins.emplaceInstruction(InstructionSignature(InstructionType::VoidIntrinsic(cmp), 0, {patternX, patternZeroPage}), encodingU8Operand, InstructionOptions({0xE4}, {1}, {}));
        builtins.emplaceInstruction(InstructionSignature(InstructionType::VoidIntrinsic(cmp), 0, {patternX, patternAbsolute}), encodingU16Operand, InstructionOptions({0xEC}, {1}, {}));
        // cpy
        builtins.emplaceInstruction(InstructionSignature(InstructionType::VoidIntrinsic(cmp), 0, {patternY, patternImmU8}), encodingU8Operand, InstructionOptions({0xC0}, {1}, {}));
        builtins.emplaceInstruction(InstructionSignature(InstructionType::VoidIntrinsic(cmp), 0, {patternY, patternZeroPage}), encodingU8Operand, InstructionOptions({0xC4}, {1}, {}));
        builtins.emplaceInstruction(InstructionSignature(InstructionType::VoidIntrinsic(cmp), 0, {patternY, patternAbsolute}), encodingU16Operand, InstructionOptions({0xCC}, {1}, {}));
        // transfer instructions
        builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternA, patternX}), encodingImplicit, InstructionOptions({0x8A}, {}, {}));
        builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternA, patternY}), encodingImplicit, InstructionOptions({0x98}, {}, {}));
        builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternX, patternA}), encodingImplicit, InstructionOptions({0xAA}, {}, {}));
        builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternY, patternA}), encodingImplicit, InstructionOptions({0xA8}, {}, {}));
        builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternX, patternS}), encodingImplicit, InstructionOptions({0xBA}, {}, {}));
        builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternS, patternX}), encodingImplicit, InstructionOptions({0x9A}, {}, {}));
        // push
        builtins.emplaceInstruction(InstructionSignature(InstructionType::VoidIntrinsic(push), 0, {patternA}), encodingImplicit, InstructionOptions({0x48}, {}, {}));
        ...
        // pop
        builtins.emplaceInstruction(InstructionSignature(InstructionType::LoadIntrinsic(pop), 0, {patternA}), encodingImplicit, InstructionOptions({0x68}, {}, {}));
        ...
        // increment
        builtins.emplaceInstruction(InstructionSignature(UnaryOperatorKind::PreIncrement, 0, {patternZeroPage}), encodingU8Operand, InstructionOptions({0xE6}, {0}, {zero}));
        builtins.emplaceInstruction(InstructionSignature(UnaryOperatorKind::PreIncrement, 0, {patternZeroPageIndexedByX}), encodingU8Operand, InstructionOptions({0xF6}, {0}, {zero}));
        builtins.emplaceInstruction(InstructionSignature(UnaryOperatorKind::PreIncrement, 0, {patternAbsolute}), encodingU16Operand, InstructionOptions({0xEE}, {0}, {zero}));
        builtins.emplaceInstruction(InstructionSignature(UnaryOperatorKind::PreIncrement, 0, {patternAbsoluteIndexedByX}), encodingU16Operand, InstructionOptions({0xFE}, {0}, {zero}));
        builtins.emplaceInstruction(InstructionSignature(UnaryOperatorKind::PreIncrement, 0, {patternX}), encodingImplicit, InstructionOptions({0xE8}, {}, {zero}));
        builtins.emplaceInstruction(InstructionSignature(UnaryOperatorKind::PreIncrement, 0, {patternY}), encodingImplicit, InstructionOptions({0xC8}, {}, {zero}));
        // decrement
        builtins.emplaceInstruction(InstructionSignature(UnaryOperatorKind::PreDecrement, 0, {patternZeroPage}), encodingU8Operand, InstructionOptions({0xC6}, {0}, {zero}));
        builtins.emplaceInstruction(InstructionSignature(UnaryOperatorKind::PreDecrement, 0, {patternZeroPageIndexedByX}), encodingU8Operand, InstructionOptions({0xD6}, {0}, {zero}));
        builtins.emplaceInstruction(InstructionSignature(UnaryOperatorKind::PreDecrement, 0, {patternAbsolute}), encodingU16Operand, InstructionOptions({0xCE}, {0}, {zero}));
        builtins.emplaceInstruction(InstructionSignature(UnaryOperatorKind::PreDecrement, 0, {patternAbsoluteIndexedByX}), encodingU16Operand, InstructionOptions({0xDE}, {0}, {zero})) ;
        builtins.emplaceInstruction(InstructionSignature(UnaryOperatorKind::PreDecrement, 0, {patternX}), encodingImplicit, InstructionOptions({0xCA}, {}, {zero}));
        builtins.emplaceInstruction(InstructionSignature(UnaryOperatorKind::PreDecrement, 0, {patternY}), encodingImplicit, InstructionOptions({0x88}, {}, {zero}));
        // bitwise negation
        builtins.emplaceInstruction(InstructionSignature(UnaryOperatorKind::BitwiseNegation, 0, {patternA}), encodingImplicit, InstructionOptions({0x49, 0xFF}, {}, {}));
        // signed negation
        builtins.emplaceInstruction(InstructionSignature(UnaryOperatorKind::SignedNegation, 0, {patternA}), encodingImplicit, InstructionOptions({0x49, 0xFF, 0x18, 0x69, 0x01}, {}, {}));
        // bitshifts
        ...
        for (const auto& op : shiftOperators) {
            builtins.emplaceInstruction(InstructionSignature(op.first, 0, {patternA, patternImmU8}), encodingRepeatedImplicit, InstructionOptions({static_cast<std::uint8_t>(op.second | 0x0A)}, {1}, {}));
            builtins.emplaceInstruction(InstructionSignature(op.first, 0, {patternZeroPage, patternImmU8}), encodingRepeatedU8Operand, InstructionOptions({static_cast<std::uint8_t>(op.second | 0x06)}, {0, 1}, {}));
            builtins.emplaceInstruction(InstructionSignature(op.first, 0, {patternZeroPageIndexedByX, patternImmU8}), encodingRepeatedU8Operand, InstructionOptions({static_cast<std::uint8_t>(op.second | 0x16)}, {0, 1}, {}));
            builtins.emplaceInstruction(InstructionSignature(op.first, 0, {patternAbsolute, patternImmU8}), encodingRepeatedU16Operand, InstructionOptions({static_cast<std::uint8_t>(op.second | 0x0E)}, {0, 1}, {}));
            builtins.emplaceInstruction(InstructionSignature(op.first, 0, {patternAbsoluteIndexedByX, patternImmU8}), encodingRepeatedU16Operand, InstructionOptions({static_cast<std::uint8_t>(op.second | 0x1E)}, {0, 1}, {}));
        }
        // jump / branch instructions
        builtins.emplaceInstruction(InstructionSignature(BranchKind::Goto, 0, {revision == Revision::Base6502 ? patternAtLeast0 : patternAtLeast1, patternImmU16}), encodingU16Operand, InstructionOptions({0x4C}, {1}, {}));
        ...
        || revision == Revision::Huc6280) {
            ...
            for (const auto& op : arithmeticOperators) {
                ...
                builtins.emplaceInstruction(InstructionSignature(op.first, 0, {patternA, patternZeroPageIndirect}), encodingU8Operand, InstructionOptions(std::move(opcode), {1}, {}));
            }
            // sta
            builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternZeroPageIndirect, patternA}), encodingU8Operand, InstructionOptions({0x92}, {0}, {}));
            // bit
            builtins.emplaceInstruction(InstructionSignature(InstructionType::VoidIntrinsic(bit), 0, {patternImmU8}), encodingU8Operand, InstructionOptions({0x89}, {0}, {}));
            builtins.emplaceInstruction(InstructionSignature(InstructionType::VoidIntrinsic(bit), 0, {patternZeroPageIndexedByX}), encodingU8Operand, InstructionOptions({0x34}, {0}, {}));
            ...
            builtins.emplaceInstruction(InstructionSignature(BranchKind::Goto, 0, {patternAtLeast0, patternIndirectJumpIndexedByX}), encodingU16Operand, InstructionOptions({0x6C}, {1}, {}));
            // push
            builtins.emplaceInstruction(InstructionSignature(InstructionType::VoidIntrinsic(push), 0, {patternX}), encodingImplicit, InstructionOptions({0xDA}, {}, {}));
            builtins.emplaceInstruction(InstructionSignature(InstructionType::VoidIntrinsic(push), 0, {patternY}), encodingImplicit, InstructionOptions({0x5A}, {}, {}));
            // pop
            builtins.emplaceInstruction(InstructionSignature(InstructionType::LoadIntrinsic(pop), 0, {patternX}), encodingImplicit, InstructionOptions({0xFA}, {}, {}));
            builtins.emplaceInstruction(InstructionSignature(InstructionType::LoadIntrinsic(pop), 0, {patternY}), encodingImplicit, InstructionOptions({0x7A}, {}, {}));
            // stz
            builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternZeroPage, pattern0}), encodingU8Operand, InstructionOptions({0x64}, {0}, {}));
            builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternZeroPageIndexedByX, pattern0}), encodingU8Operand, InstructionOptions({0x74}, {0}, {}));
            builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternAbsolute, pattern0}), encodingU16Operand, InstructionOptions({0x9C}, {0}, {}));
            builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternAbsoluteIndexedByX, pattern0}), encodingU16Operand, InstructionOptions({0x9E}, {0}, {}));
            // trb
            builtins.emplaceInstruction(InstructionSignature(InstructionType::VoidIntrinsic(test_and_reset), 0, {patternZeroPage, patternA}), encodingU8Operand, InstructionOptions({0x14}, {0}, {}));
            builtins.emplaceInstruction(InstructionSignature(InstructionType::VoidIntrinsic(test_and_reset), 0, {patternAbsolute, patternA}), encodingU16Operand, InstructionOptions({0x1C}, {0}, {}));
            // tsb
            builtins.emplaceInstruction(InstructionSignature(InstructionType::VoidIntrinsic(test_and_set), 0, {patternZeroPage, patternA}), encodingU8Operand, InstructionOptions({0x04}, {0}, {}));
            builtins.emplaceInstruction(InstructionSignature(InstructionType::VoidIntrinsic(test_and_set), 0, {patternAbsolute, patternA}), encodingU16Operand, InstructionOptions({0x0C}, {0}, {}));
        }
        ...
        || revision == Revision::Huc6280) {
            ...
            const auto encodingU8OperandBitIndexLongBranch = builtins.emplaceInstructionEncoding(
                [](const InstructionOptions& options, const std::vector<std::vector<const InstructionOperand*>>& captureLists) {
                    static_cast<void>(captureLists);
            ...
            builtins.emplaceInstruction(InstructionSignature(BranchKind::Goto, 0, {patternAtLeast0, patternImmU16, patternZeroPageBitIndex, patternFalse}), encodingU8OperandBitIndexBranch, InstructionOptions({0x0F}, {2, 2, 1, 1}, {}));
            builtins.emplaceInstruction(InstructionSignature(BranchKind::Goto, 0, {patternAtLeast0, patternImmU16, patternZeroPageBitIndex, patternTrue}), encodingU8OperandBitIndexBranch, InstructionOptions({0x8F}, {2, 2, 1, 1}, {}));
            // long branch on bit - goto label if zp $ n;
            builtins.emplaceInstruction(InstructionSignature(BranchKind::Goto, 0, {patternAtLeast0, patternImmU16, patternZeroPageBitIndex, patternFalse}), encodingU8OperandBitIndexLongBranch, InstructionOptions({0x8F, 3, 0x4C}, {2, 2, 1, 1}, {}));
            builtins.emplaceInstruction(InstructionSignature(BranchKind::Goto, 0, {patternAtLeast0, patternImmU16, patternZeroPageBitIndex, patternTrue}), encodingU8OperandBitIndexLongBranch, InstructionOptions({0x0F, 3, 0x4C}, {2, 2, 1, 1}, {}));
            // zp $ n = false
            // zp $ n = true
            builtins.emplaceInstruction(InstructionSignature(InstructionType(BinaryOperatorKind::Assignment), 0, {patternZeroPageBitIndex, patternFalse}), encodingU8OperandBitIndex, InstructionOptions({0x07}, {0, 0, 1}, {}));
            builtins.emplaceInstruction(InstructionSignature(InstructionType(BinaryOperatorKind::Assignment), 0, {patternZeroPageBitIndex, patternTrue}), encodingU8OperandBitIndex, InstructionOptions({0x87}, {0, 0, 1}, {}));
        }
        ...
        if (revision == Revision::Wdc65C02) {
            ...
            builtins.emplaceInstruction(InstructionSignature(InstructionType::VoidIntrinsic(stop_until_reset), 0, {}), encodingImplicit, InstructionOptions({0xDB}, {0}, {}));
            builtins.emplaceInstruction(InstructionSignature(InstructionType::VoidIntrinsic(wait_until_interrupt), 0, {}), encodingImplicit, InstructionOptions({0xCB}, {0}, {}));
        }

        // Extra Huc6280 instructions
        if (revision == Revision::Huc6280) {
            // See: http://archaicpixels.com/HuC6280_Instruction_Set
            const auto patternIndirectX = builtins.emplaceInstructionOperandPattern(InstructionOperandPattern::Dereference(false, patternX->clone(), 1));
            const auto patternTurboSpeed = builtins.emplaceInstructionOperandPattern(InstructionOperandPattern::Register(scope->emplaceDefinition(nullptr, Definition::BuiltinRegister(boolType), stringPool->intern("turbo_speed"), decl)));
            const auto patternVdcSelect = builtins.emplaceInstructionOperandPattern(InstructionOperandPattern::Register(scope->emplaceDefinition(nullptr, Definition::BuiltinRegister(u8Type), stringPool->intern("vdc_select"), decl)));
            const auto patternVdcDataL = builtins.emplaceInstructionOperandPattern(InstructionOperandPattern::Register(scope->emplaceDefinition(nullptr, Definition::BuiltinRegister(u8Type), stringPool->intern("vdc_data_l"), decl)));
            const auto patternVdcDataH = builtins.emplaceInstructionOperandPattern(InstructionOperandPattern::Register(scope->emplaceDefinition(nullptr, Definition::BuiltinRegister(u8Type), stringPool->intern("vdc_data_h"), decl)));
            const auto patternMPR0 = builtins.emplaceInstructionOperandPattern(InstructionOperandPattern::Register(scope->emplaceDefinition(nullptr, Definition::BuiltinRegister(u8Type), stringPool->intern("mpr0"), decl)));
            const auto patternMPR1 = builtins.emplaceInstructionOperandPattern(InstructionOperandPattern::Register(scope->emplaceDefinition(nullptr, Definition::BuiltinRegister(u8Type), stringPool->intern("mpr1"), decl)));
            const auto patternMPR2 = builtins.emplaceInstructionOperandPattern(InstructionOperandPattern::Register(scope->emplaceDefinition(nullptr, Definition::BuiltinRegister(u8Type), stringPool->intern("mpr2"), decl)));
            const auto patternMPR3 = builtins.emplaceInstructionOperandPattern(InstructionOperandPattern::Register(scope->emplaceDefinition(nullptr, Definition::BuiltinRegister(u8Type), stringPool->intern("mpr3"), decl)));
            const auto patternMPR4 = builtins.emplaceInstructionOperandPattern(InstructionOperandPattern::Register(scope->emplaceDefinition(nullptr, Definition::BuiltinRegister(u8Type), stringPool->intern("mpr4"), decl)));
            const auto patternMPR5 = builtins.emplaceInstructionOperandPattern(InstructionOperandPattern::Register(scope->emplaceDefinition(nullptr, Definition::BuiltinRegister(u8Type), stringPool->intern("mpr5"), decl)));
            const auto patternMPR6 = builtins.emplaceInstructionOperandPattern(InstructionOperandPattern::Register(scope->emplaceDefinition(nullptr, Definition::BuiltinRegister(u8Type), stringPool->intern("mpr6"), decl)));
            const auto patternMPR7 = builtins.emplaceInstructionOperandPattern(InstructionOperandPattern::Register(scope->emplaceDefinition(nullptr, Definition::BuiltinRegister(u8Type), stringPool->intern("mpr7"), decl)));

            const auto swap = scope->emplaceDefinition(nullptr, Definition::BuiltinVoidIntrinsic(), stringPool->intern("swap"), decl);
            const auto transfer_alternate_to_increment = scope->emplaceDefinition(nullptr, Definition::BuiltinVoidIntrinsic(), stringPool->intern("transfer_alternate_to_increment"), decl);
            const auto transfer_increment_to_alternate = scope->emplaceDefinition(nullptr, Definition::BuiltinVoidIntrinsic(), stringPool->intern("transfer_increment_to_alternate"), decl);
            const auto transfer_decrement_to_decrement = scope->emplaceDefinition(nullptr, Definition::BuiltinVoidIntrinsic(), stringPool->intern("transfer_decrement_to_decrement"), decl);
            const auto transfer_increment_to_increment = scope->emplaceDefinition(nullptr, Definition::BuiltinVoidIntrinsic(), stringPool->intern("transfer_increment_to_increment"), decl);
            const auto transfer_increment_to_fixed = scope->emplaceDefinition(nullptr, Definition::BuiltinVoidIntrinsic(), stringPool->intern("transfer_increment_to_fixed"), decl);
            const auto mpr_set = scope->emplaceDefinition(nullptr, Definition::BuiltinVoidIntrinsic(), stringPool->intern("mpr_set"), decl);

            tst = scope->emplaceDefinition(nullptr, Definition::BuiltinVoidIntrinsic(), stringPool->intern("tst"), decl);

            const auto encodingZeroPageBitwiseTest = builtins.emplaceInstructionEncoding(
                [](const InstructionOptions& options, const std::vector<std::vector<const InstructionOperand*>>& captureLists) {
                    static_cast<void>(captureLists);
                    return options.opcode.size() + 3;
                },
            ...
            const auto encodingAbsoluteBitwiseTest = builtins.emplaceInstructionEncoding(
                [](const InstructionOptions& options, const std::vector<std::vector<const InstructionOperand*>>& captureLists) {
                    static_cast<void>(captureLists);
                    return options.opcode.size() + 3;
                },
            ...
            const auto encodingBlockTransfer = builtins.emplaceInstructionEncoding(
                [](const InstructionOptions& options, const std::vector<std::vector<const InstructionOperand*>>& captureLists) {
                    static_cast<void>(captureLists);
            ...
            // cla / clx / cly
            builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternA, pattern0}), encodingImplicit, InstructionOptions({0x62}, {}, {}));
            builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternX, pattern0}), encodingImplicit, InstructionOptions({0x82}, {}, {}));
            builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternY, pattern0}), encodingImplicit, InstructionOptions({0xC2}, {}, {}));
            // csl / csh
            builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternTurboSpeed, patternFalse}), encodingImplicit, InstructionOptions({0xD4}, {}, {}));
            builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternTurboSpeed, patternTrue}), encodingImplicit, InstructionOptions({0x54}, {}, {}));
            // sax / say / sxy
            builtins.emplaceInstruction(InstructionSignature(InstructionType::VoidIntrinsic(swap), 0, {patternA, patternX}), encodingImplicit, InstructionOptions({0x22}, {0}, {}));
            builtins.emplaceInstruction(InstructionSignature(InstructionType::VoidIntrinsic(swap), 0, {patternA, patternY}), encodingImplicit, InstructionOptions({0x42}, {0}, {}));
            builtins.emplaceInstruction(InstructionSignature(InstructionType::VoidIntrinsic(swap), 0, {patternX, patternY}), encodingImplicit, InstructionOptions({0x02}, {0}, {}));
            ...
            for (const auto& arithmeticOperator : arithmeticOperators) {
                ...
                if (canUseTFlag) {
                    for (const auto& sig : arithmeticOperandSignatures) {
                        ...
                        opcode[opcode.size() - 1] |= std::get<2>(sig);
                        builtins.emplaceInstruction(InstructionSignature(arithmeticOperator.first, 0, {patternIndirectX, std::get<0>(sig)}), std::get<1>(sig), InstructionOptions(std::move(opcode), {1}, {}));
                    }
                }
            }
            // st0 / st1 / st2 - set vdc register n to immediate value.
            builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternVdcSelect, patternImmU8}), encodingU8Operand, InstructionOptions({0x03}, {1}, {}));
            builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternVdcDataL, patternImmU8}), encodingU8Operand, InstructionOptions({0x13}, {1}, {}));
            builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternVdcDataH, patternImmU8}), encodingU8Operand, InstructionOptions({0x23}, {1}, {}));
            // block transfers: tai/tia/tdd/tii/tin
            builtins.emplaceInstruction(InstructionSignature(InstructionType::VoidIntrinsic(transfer_alternate_to_increment), 0, {patternImmU16, patternImmU16, patternImmU16}), encodingBlockTransfer, InstructionOptions({0xF3}, {0, 1, 2}, {}));
            builtins.emplaceInstruction(InstructionSignature(InstructionType::VoidIntrinsic(transfer_increment_to_alternate), 0, {patternImmU16, patternImmU16, patternImmU16}), encodingBlockTransfer, InstructionOptions({0xE3}, {0, 1, 2}, {}));
            builtins.emplaceInstruction(InstructionSignature(InstructionType::VoidIntrinsic(transfer_decrement_to_decrement), 0, {patternImmU16, patternImmU16, patternImmU16}), encodingBlockTransfer, InstructionOptions({0xC3}, {0, 1, 2}, {}));
            builtins.emplaceInstruction(InstructionSignature(InstructionType::VoidIntrinsic(transfer_increment_to_increment), 0, {patternImmU16, patternImmU16, patternImmU16}), encodingBlockTransfer, InstructionOptions({0x73}, {0, 1, 2}, {}));
            builtins.emplaceInstruction(InstructionSignature(InstructionType::VoidIntrinsic(transfer_increment_to_fixed), 0, {patternImmU16, patternImmU16, patternImmU16}), encodingBlockTransfer, InstructionOptions({0xD3}, {0, 1, 2}, {}));
            // tam - modify MPR0-7 based on accumulator
            builtins.emplaceInstruction(InstructionSignature(InstructionType::VoidIntrinsic(mpr_set), 0, {patternImmU8, patternA}), encodingU8Operand, InstructionOptions({0x53}, {0}, {}));
            builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternMPR0, patternA}), encodingImplicit, InstructionOptions({0x53, 0x01}, {}, {}));
            builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternMPR1, patternA}), encodingImplicit, InstructionOptions({0x53, 0x02}, {}, {}));
            builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternMPR2, patternA}), encodingImplicit, InstructionOptions({0x53, 0x04}, {}, {}));
            builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternMPR3, patternA}), encodingImplicit, InstructionOptions({0x53, 0x08}, {}, {}));
            builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternMPR4, patternA}), encodingImplicit, InstructionOptions({0x53, 0x10}, {}, {}));
            builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternMPR5, patternA}), encodingImplicit, InstructionOptions({0x53, 0x20}, {}, {}));
            builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternMPR6, patternA}), encodingImplicit, InstructionOptions({0x53, 0x40}, {}, {}));
            builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternMPR7, patternA}), encodingImplicit, InstructionOptions({0x53, 0x80}, {}, {}));
            // tma - read MPRn into accumulator
            builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternA, patternMPR0}), encodingImplicit, InstructionOptions({0x43, 0x01}, {}, {}));
            builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternA, patternMPR1}), encodingImplicit, InstructionOptions({0x43, 0x02}, {}, {}));
            builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternA, patternMPR2}), encodingImplicit, InstructionOptions({0x43, 0x04}, {}, {}));
            builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternA, patternMPR3}), encodingImplicit, InstructionOptions({0x43, 0x08}, {}, {}));
            builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternA, patternMPR4}), encodingImplicit, InstructionOptions({0x43, 0x10}, {}, {}));
            builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternA, patternMPR5}), encodingImplicit, InstructionOptions({0x43, 0x20}, {}, {}));
            builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternA, patternMPR6}), encodingImplicit, InstructionOptions({0x43, 0x40}, {}, {}));
            builtins.emplaceInstruction(InstructionSignature(BinaryOperatorKind::Assignment, 0, {patternA, patternMPR7}), encodingImplicit, InstructionOptions({0x43, 0x80}, {}, {}));
            // tst #imm, mem - overflow = mem $ 6, negative = mem $ 7, zero = imm & mem
            builtins.emplaceInstruction(InstructionSignature(InstructionType::VoidIntrinsic(tst), 0, {patternImmU8, patternZeroPage}), encodingZeroPageBitwiseTest, InstructionOptions({0x83}, {0, 1}, {}));
            builtins.emplaceInstruction(InstructionSignature(InstructionType::VoidIntrinsic(tst), 0, {patternImmU8, patternZeroPageIndexedByX}), encodingZeroPageBitwiseTest, InstructionOptions({0xA3}, {0, 1}, {}));
            builtins.emplaceInstruction(InstructionSignature(InstructionType::VoidIntrinsic(tst), 0, {patternImmU8, patternAbsolute}), encodingAbsoluteBitwiseTest, InstructionOptions({0x93}, {0, 1}, {}));
            builtins.emplaceInstruction(InstructionSignature(InstructionType::VoidIntrinsic(tst), 0, {patternImmU8, patternAbsoluteIndexedByX}), encodingAbsoluteBitwiseTest, InstructionOptions({0xB3}, {0, 1}, {}));
        }
    }
    ...
    std::unique_ptr<PlatformTestAndBranch> Mos6502Platform::getTestAndBranch(const Compiler& compiler, BinaryOperatorKind op, const Expression* left, const Expression* right, std::size_t distanceHint) const {
