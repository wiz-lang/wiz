...
namespace wiz {
    ...
    void Wdc65816Platform::reserveDefinitions(Builtins& builtins) {
        ...
        const TransferOp transferOps[] {
            {patternA, patternX, modeMem8 | modeIdx8, 0x8A},
            {patternX, patternA, modeMem8 | modeIdx8, 0xAA},
            {patternA, patternX, modeMem8 | modeIdx16, 0x8A},
            {patternXX, patternAA, modeMem8 | modeIdx16, 0xAA},
            {patternAA, patternXX, modeMem16 | modeIdx8, 0x8A},
            {patternX, patternA, modeMem16 | modeIdx8, 0xAA},
            {patternAA, patternXX, modeMem16 | modeIdx16, 0x8A},
            {patternXX, patternAA, modeMem16 | modeIdx16, 0xAA},

            {patternA, patternY, modeMem8 | modeIdx8, 0x98},
            {patternY, patternA, modeMem8 | modeIdx8, 0xA8},
            {patternA, patternY, modeMem8 | modeIdx16, 0x98},
            {patternYY, patternAA, modeMem8 | modeIdx16, 0xA8},
            {patternAA, patternYY, modeMem16 | modeIdx8, 0x98},
            {patternY, patternA, modeMem16 | modeIdx8, 0xA8},
            {patternAA, patternYY, modeMem16 | modeIdx16, 0x98},
            {patternYY, patternAA, modeMem16 | modeIdx16, 0xA8},

            {patternX, patternS, modeIdx8, 0xBA},
            {patternS, patternX, modeIdx8, 0x9A},
            {patternXX, patternSS, modeIdx16, 0xBA},
            {patternSS, patternXX, modeIdx16, 0x9A},

            {patternAA, patternSS, 0, 0x3B},
            {patternSS, patternAA, 0, 0x1B},

            {patternA, patternDirectPageRegister, 0, 0x7B},
            {patternDirectPageRegister, patternA, 0, 0x5B},

            {patternX, patternY, modeIdx8, 0xBB},
            {patternY, patternX, modeIdx8, 0x9B},
            {patternXX, patternYY, modeIdx16, 0xBB},
            {patternYY, patternXX, modeIdx16, 0x9B},
        };
